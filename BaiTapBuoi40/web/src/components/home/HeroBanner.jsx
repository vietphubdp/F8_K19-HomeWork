      ...
      <Container maxWidth="lg">
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Typography variant="h3" component="h1" sx={{ fontWeight: 800, mb: 1.5, fontSize: { xs: '1.8rem', md: '2.5rem' }, lineHeight: 1.2 }}>
              Tìm việc làm nhanh 24h, việc làm mới nhất toàn quốc
            </Typography>
            <Typography variant="h6" sx={{ fontWeight: 400, opacity: 0.9, mb: 4, fontSize: { xs: '1rem', md: '1.15rem' } }}>
              Thâm nhập hệ sinh thái HR Tech hàng đầu với +30.000 việc làm được xác thực mỗi ngày
            </Typography>
          ...
          <Grid item xs={12} md={5} sx={{ display: { xs: 'none', md: 'block' } }}>
            ...
            >
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2 }}>
                <VerifiedIcon sx={{ color: '#00ff75', fontSize: 32 }} />
                <Box>
                  <Typography variant="h6" sx={{ fontWeight: 700 }}>
                    Công nghệ AI Connect 4.0
                  </Typography>
                  <Typography variant="body2" sx={{ opacity: 0.8 }}>
                    Gợi ý việc làm chuẩn xác dựa trên CV của bạn
                  </Typography>
                </Box>
              </Stack>

              <Stack direction="row" spacing={2} sx={{ mt: 3 }}>
                <Paper sx={{ p: 2, flex: 1, backgroundColor: 'rgba(0,0,0,0.2)', color: '#fff', borderRadius: 2 }}>
                  <Typography variant="h4" sx={{ fontWeight: 800, color: '#00ff75' }}>
                    140.000+
                  </Typography>
                  <Typography variant="body2" sx={{ opacity: 0.8 }}>
                    Việc làm đang tuyển
